...
from sql_app.crud import get_or_create_character, get_or_create_superpower
...
def create_default_characters(db_session: Session):
    ...
    get_or_create_superpower(db_session, "Taladoken", 3, "DSDP", c1)
    get_or_create_superpower(db_session, "Remuyuken", 2, "SDK", c1)
    get_or_create_superpower(db_session, "Remuyuken", 3, "SAK", c2)
    get_or_create_superpower(db_session, "Taladoken", 3, "ASAP", c2)
